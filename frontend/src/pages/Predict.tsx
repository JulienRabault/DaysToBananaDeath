...
export const Predict = () => {
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : t.predictionError);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{t.predictionTitle}</h1>
